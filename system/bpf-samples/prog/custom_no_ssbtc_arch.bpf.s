...
.Ltmp71:
	...
	# fp-64 was not initialized yet (STACK_INVALID)
	#
	# Create Spec. Type Confusion:
	r2 = 8
    r8 = 0   # scalar for type confusion
    r9 = r10 # fp alias for ssb
    # NOT: *(u64 *)(r10 - 64) = r6 # ctx_ptr
    *(u64 *)(r9 - 64) = r8  # write scalar, SSB can NOT happen here
	# lfence added here because this was the first store to the stack slot.
