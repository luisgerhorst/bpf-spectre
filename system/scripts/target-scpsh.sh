...
ssh="ssh ${SSH_DEST} -p ${SSH_PORT} -o BatchMode=true -o NoHostAuthenticationForLocalhost=true -o ConnectionAttempts=60 -o ConnectTimeout=30"
scp="scp -P ${SSH_PORT} -B -o NoHostAuthenticationForLocalhost=true -q -o ConnectionAttempts=60 -o ConnectTimeout=30"
