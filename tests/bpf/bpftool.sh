...
$cs "bpftool --debug prog loadall $obj $path" 2> ../result_dir/loadall.log
exitcode=$?
...
then
    ...
    do
        ...
        $cs "bpftool --debug prog loadall $obj $path type $type" 2>> ../result_dir/loadall/$type_path.log
        exitcode=$?
